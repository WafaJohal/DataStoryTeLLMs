...
def main():
    st.title("Interactive Dataset Explorer with Swarm Agents")
...
def get_data_analyst_instructions():
    ...
    - Perform exploratory data analysis (EDA) to understand the data's structure and content.
    - Identify anomalies, missing values, and data quality issues, and suggest corrective measures.
    - Use statistical methods, machine learning models, or advanced techniques to uncover meaningful insights.
    - Create clear and informative visualizations and dashboards to present findings.
    - Communicate results effectively to both technical and non-technical stakeholders.
    - Optimize analysis workflows and contribute to data-driven strategies.

    Expectations:
    - Ask clarifying questions if the analysis goal is not fully defined.
    - Provide a step-by-step explanation of your approach when requested.
    ...
    - Stay updated with the latest tools, techniques, and best practices in data analysis.

    Begin by understanding the problem statement, the dataset, and the desired outcomes."""
